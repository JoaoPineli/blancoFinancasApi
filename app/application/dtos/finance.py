...
# ------------------------------------------------------------------
# Activation Payment DTOs (unified — backed by transactions table)
# ------------------------------------------------------------------


@dataclass
class CreateActivationPaymentInput:
    """Input for creating a subscription activation payment."""
...
class ActivationPaymentDTO:
    """DTO for a subscription activation payment."""
